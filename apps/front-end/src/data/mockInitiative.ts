 const mockInitiative = {
   ...
   dc_domains: ["credicoopdigital.coop", "tusueldoencredicoop.coop", "puntoscredicoop.coop", "sipago.coop", "portaldetienda.coop", "portaldetiendas.coop", "pagocoop.coop", "pago.coo", "inverpymes.coop", "mipago.coop", "futbolcoop.coop","emprendedor21.coop", "emprendedorxxi.coop", "credicoopylacomunidad.coop", "comprecooperativo.coop", "credicoopmovil.coop", "cobranzadefacturas.coop", "bccl.coop", "cabaluniversitaria.coop", "bancocredicoop.coop"],
   country_id: "coun:AR",
