...
GitHub from the pull requests merged since the last release. You
need the GitHub Cli tool from https://github.com/cli to run it.
Note that this script is totally optionally. You can look at the
git history yourself and write the CHANGELOG.md file by hand.
